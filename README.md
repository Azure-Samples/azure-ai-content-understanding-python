...
* **Trademarks**  
  This project may contain trademarks or logos for products or services. Authorized use of Microsoft trademarks or logos must comply with [Microsoft's Trademark & Brand Guidelines](https://www.microsoft.com/en-us/legal/intellectualproperty/trademarks/usage/general). Use of Microsoft trademarks or logos in modified versions of this project must not cause confusion or imply Microsoft sponsorship. Use of third-party trademarks or logos is subject to their respective policies.

* **Data Collection**  
  The software may collect information about you and your usage and send it to Microsoft. Microsoft may use this information to provide and improve our products and services. You can disable telemetry as described in this repository. Some features may enable you and Microsoft to collect data from your applications’ users. If you use these features, you must comply with applicable laws, including providing appropriate notices to your users along with a copy of Microsoft’s privacy statement, available at [Microsoft Privacy Statement](https://go.microsoft.com/fwlink/?LinkID=824704). Use of the software constitutes your consent to these practices.